---
title: L'automatisation comme indice de facticité
date: 2025-05-21
update: 2025-05-21
lang: fr
description: l'ia donne une première impression de facticité.
slug: 2025-05-21-L-automatisation-d-un-media-comme-indice-de-facticite
translation: 
tags:
  - IA
  - facticité
...
Une de ces craintes est que le web, et plus généralement les environnements informationnels numériques, sont petit à petit en train de se remplir de [slop](https://fr.wikipedia.org/wiki/Slop_(intelligence_artificielle)), c'est-à-dire d'informations fausses ou de mauvaise qualité générées automatiquement au moyen d'outils d'IA.  En corollaire, il est possible de penser que devoir naviguer quotidiennement dans un environnement numérique saturé de slop pourrait accentuer les [désordres informationnels](https://www.coe.int/fr/web/freedom-expression/information-disorder) déjà identifiés : désinformation, mal-information, mésinformation, ect. 

Une seconde dimension de cette crainte est que dans un environnement informationnel numérique où les contenus sont de plus en plus produits par ce que mes collègues Jerry Jacques et Antonin Descampe appellent des "[médias automatisés](https://www.acfas.ca/sites/default/files/2025-01/aac-acfas-2025-medias-automatises_1.pdf)", il deviendra de plus en plus difficile d'évaluer tant la fiabilité des sources que la facticité des contenus auxquels nous sommes confrontés. 
